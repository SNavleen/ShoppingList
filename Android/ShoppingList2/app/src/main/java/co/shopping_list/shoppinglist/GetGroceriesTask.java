 ...
 */
class GetGroceriesTask extends AsyncTask<Void, Void, String[]> {
    private final String TAG = "GetGroceriesTask";

    ArrayAdapter<String> mAdapter;

    public GetGroceriesTask(ArrayAdapter<String> adapter) {
        mAdapter = adapter;
    }
    ...
    protected String[] doInBackground(Void... params) {
        ...
        String json = null;
        try {
            BaseURL = new URL("http://gcp-hackthenorth-3212.appspot.com/?item=true");
